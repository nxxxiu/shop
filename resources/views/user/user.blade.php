...
@section('content')
    ...
    <ul class="userNav">
        ...
        <li><span class="glyphicon glyphicon-usd"></span><a href="/user/coupon">我的优惠券</a></li>
        <li><span class="glyphicon glyphicon-map-marker"></span><a href="/user/address">收货地址管理</a></li>
        <li><span class="glyphicon glyphicon-star-empty"></span><a href="/user/collect">我的收藏</a></li>
        <li><span class="glyphicon glyphicon-heart"></span><a href="/user/collect">我的浏览记录</a></li>
        <li><span class="glyphicon glyphicon-usd"></span><a href="/user/cash">余额提现</a></li>
    </ul><!--userNav/-->
    <div class="lrSub">
